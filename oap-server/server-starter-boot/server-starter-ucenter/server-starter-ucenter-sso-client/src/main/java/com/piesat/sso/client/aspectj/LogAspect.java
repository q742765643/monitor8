package com.piesat.sso.client.aspectj;
...
import com.piesat.sso.client.enums.BusinessStatus;
import com.piesat.sso.client.util.AddressUtils;
import com.piesat.sso.client.util.IpUtils;
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            if (e != null) {
                ...
                operLog.setErrorMsg(OwnException.get(e));
            }
            // 设置方法名称
