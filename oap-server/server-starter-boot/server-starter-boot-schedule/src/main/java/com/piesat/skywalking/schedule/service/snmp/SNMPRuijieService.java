...
@Service
public class SNMPRuijieService extends SNMPService{
    @Autowired
    ...
    public void cpuMap(SNMPSessionUtil snmp, Map<String,Object> basicInfo, List<Map<String,Object>> esList) {
        ...
        ArrayList<String> cpuList = snmp.snmpWalk2(ruijieCpu); //五分钟平均利用率
        float total=new BigDecimal(cpuList.get(0)).floatValue();
    ...
    public void memoryMap(SNMPSessionUtil snmp,Map<String,Object> basicInfo,List<Map<String,Object>> esList) {
        ...
        String[] ruijieMem = {"1.3.6.1.4.1.4881.1.1.10.2.35.1.1.1.3.1"};//内存使用率
        ArrayList<String> memUsed = snmp.getSnmpGet(PDU.GET, ruijieMem);
        BigDecimal free =new BigDecimal(0); //MB/1024/1024
        BigDecimal used = new BigDecimal(0);//MB/1024/1024
        BigDecimal total=free.add(used);
        BigDecimal usedRate=new BigDecimal(memUsed.get(0));
