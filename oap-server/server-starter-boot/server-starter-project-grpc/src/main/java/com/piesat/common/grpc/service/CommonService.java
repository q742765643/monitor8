...
public class CommonService extends CommonServiceGrpc.CommonServiceImplBase {
    ...
    @Override
    public void handle(GrpcGeneral.Request request, StreamObserver<GrpcGeneral.Response> responseObserver) {
        ...
        GrpcGeneral.Response grpcResponse = GrpcGeneral.Response.newBuilder().setResponse(bytes).build();
