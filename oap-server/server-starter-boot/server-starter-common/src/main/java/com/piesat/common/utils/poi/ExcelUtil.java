package com.piesat.common.utils.poi;
        ...
        if (rows > 0) {
            ...
            for (int i = 1; i < rows; i++) {
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet()) {
                    ...
                    Excel attr1 = field.getAnnotation(Excel.class);
                    if (StringUtils.isNotEmpty(attr1.readConverterExp())) {
                        val = reverseByExp(String.valueOf(val), attr1.readConverterExp());
                    }
                    // 取得类型,并根据对象类型设置值.
