<template lang="html">
  <div :val="value_" class="singleCon">
    ...
    <div class="timeTitle">
      <el-checkbox v-model="checkedType" label="时" @change="checkedTypeChange"></el-checkbox>
    ...
    <div v-show="type==4?true:false" class="timeCon">
      <el-checkbox-group v-model="appoint">
        <div  v-for="i in 3" :key="i" style="margin-left: 10px;  line-height: 25px;">
          <el-checkbox @change="hasChecked"  v-for="j in 10" v-if="parseInt((i - 1) + '' + (j - 1)) < 24" :key="j" :label="(i - 1) + '' + (j - 1)"></el-checkbox>
        </div>
      </el-checkbox-group>
