<template lang="html">
  <div :val="value_" class="singleCon">
    ...
    <div v-if="false">
      <el-radio v-model="type" label="3" size="mini" border>间隔</el-radio>
    ...
    <div class="timeTitle">
      <el-checkbox v-model="checkedType" label="周" @change="checkedTypeChange"></el-checkbox>
    ...
    <div v-show="type==4?true:false" class="timeCon">
      <el-checkbox-group v-model="appoint" style="margin-left: 50px;  line-height: 25px;">
          <el-checkbox @change="hasChecked"  v-for="i in 7" :key="i" :label="i+''"></el-checkbox>
      </el-checkbox-group>
