  ...
  <div class="departmentTemplate">
    <a-form-model layout="inline" :model="queryParams" class="queryForm">
      ...
      <a-form-model-item>
        ...
        <a-button type="primary" :style="{ marginLeft: '8px' }" @click="handleAdd"> 新增 </a-button>
      </a-form-model-item>
    </a-form-model>
      ...
      >
        ...
        <vxe-table-column title="操作" width="400" align="left">
          <template v-slot="{ row }">
            ...
            <a-button type="danger" icon="plus" @click="handleAdd(row)"> 新增 </a-button>
        ...
        <a-row>
          <a-col :span="24" v-if="formDialog.parentId !== '0'">
            <a-form-model-item label="上级部门" prop="parentId">
              <treeselect v-model.trim="formDialog.parentId" :options="deptOptions" placeholder="选择上级部门" />
            </a-form-model-item>
          </a-col>
        </a-row>
        <a-row>
