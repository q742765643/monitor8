    ...
    <div id="header">
      <div id="select">
        ...
        <a-select v-model="selctValue" default-value="IP" style="width: 3.2rem; font-size: 0.185rem" size="small">
          ...
          <a-select-option value="address"> 详细地址 </a-select-option>
        </a-select>
      </div>
      <div id="query">
        <!--  <input
      ...
      <span
          class="iconfont icondustbin_icon"
          @click="$refs.xTable.removeCheckboxRow()"
          >删除</span
        >
        <span class="iconfont icontianjia1" @click="showTopuMoadl = true"
          >从链路中添加</span
        > -->
        <a-button type="primary" icon="plus-circle" @click="insertDevice">
          添加
        </a-button>
          ...
          <vxe-table-column title="操作" width="160">
            <template v-slot="{ row }">
              <template v-if="$refs.xTable.isActiveByRow(row)">
                ...
                <!--  <span
                  class="iconfont iconiconfontcheck"
              ...
              <template v-else>
                ...
                <!--  <span class="iconfont iconbianji1" @click="editRowEvent(row)"
                  >编辑</span> -->
