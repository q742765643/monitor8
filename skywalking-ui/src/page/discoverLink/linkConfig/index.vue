    ...
    <div id="linkConfig_contnet">
      <div id="topconfig">
        ...
        <div class="startIP">
          ...
          <div class="ip">
            <a-input placeholder="" />
            <span class="dunder">—</span> <a-input placeholder="" /><span class="dunder">—</span>
        ...
        <div class="endIP">
          <span>结束IP</span>
          <div class="ip">
            <a-input placeholder="" /><span class="dunder">—</span> <a-input placeholder="" /><span class="dunder"
              >—</span
            >
            <a-input placeholder="" /><span class="dunder">—</span>
            <a-input placeholder="" />
  ...
  export default {
    ...
    methods: {
      setTableHeight() {
        ...
        let padding = getComputedStyle(document.getElementById('linkConfig_contnet'), false)['paddingTop'];
