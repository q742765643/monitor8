...
<script>
  ...
  export default {
    ...
    mounted() {
      this.$nextTick(() => {
        this.drawChart('statuChart', this.statuChart, this.totalMaster, this.readyMater, this.lnerColors[0]);
        this.drawChart('cpuChart', this.cpuChart, this.totalCpu, this.usageCpu, this.lnerColors[1]);
        this.drawChart('romChart', this.romChart, this.totalRom, this.usageRom, this.lnerColors[2]);
      });
    },
    methods: {
