...
<script lang="ts">
  ...
  import ChartLine from '../../../components/topology/chart-line.vue';
  ...
  export default class TopoDetectPoint extends Vue {
    ...
    @Mutation('rocketTopoNetwork/SET_MODE_STATUS') private SET_MODE_STATUS: any;
    @Mutation('rocketTopoNetwork/SET_SELECTED_INSTANCE_CALL')
    private SET_SELECTED_INSTANCE_CALL: any;
    @Mutation('rocketTopoNetwork/SET_INSTANCE_DEPENDENCY')
    private SET_INSTANCE_DEPENDENCY: any;
    @Action('rocketTopoNetwork/CLEAR_TOPO_INFO') private CLEAR_TOPO_INFO: any;
    @Action('rocketTopoNetwork/GET_TOPO_INSTANCE_DEPENDENCY')
    private GET_INSTANCE_DEPENDENCY: any;
    @Action('rocketTopoNetwork/GET_TOPO_SERVICE_DETAIL') private GET_TOPO_SERVICE_DETAIL: any;
