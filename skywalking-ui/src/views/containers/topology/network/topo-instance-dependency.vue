...
<script lang="ts">
  ...
  import DependencySankey from '../../../components/topology/dependency-sankey.vue';
  ...
  export default class TopoInstanceDependency extends Vue {
    ...
    @Mutation('rocketTopoNetwork/SET_INSTANCE_DEPEDENCE_TYPE')
    private SET_MODE_STATUS: any;
    @Action('rocketTopoNetwork/GET_INSTANCE_DEPENDENCY_METRICS')
