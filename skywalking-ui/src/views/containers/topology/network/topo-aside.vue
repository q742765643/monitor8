...
<script lang="ts">
  ...
  import topo, { State as topoState } from '@/store/modules/network';
  import { Component, Vue, Watch } from 'vue-property-decorator';
  import { Action, Getter, Mutation, State } from 'vuex-class';
  import Radial from '../../../components/topology/radial.vue';
  import TopoChart from '../../../components/topology/topo-chart.vue';
  ...
  export default class TopoAside extends Vue {
    ...
    private handleRefresh() {
      this.$store.dispatch(
        this.stateTopo.mode ? 'rocketTopoNetwork/GET_TOPO_SERVICE_INFO' : 'rocketTopoNetwork/GET_TOPO_CLIENT_INFO',
